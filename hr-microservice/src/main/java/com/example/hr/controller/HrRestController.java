...
public class HrRestController {
	...
	public EmployeeResponse findEmployee(@PathVariable @TcKimlikNo String kimlikNo) {
	...
	public EmployeeResponse fireEmployee(@PathVariable @TcKimlikNo String kimlikNo) {
